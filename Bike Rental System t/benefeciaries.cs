    ...
    public partial class benefeciaries : Form
    {
        ...
        private void addbut_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //string query = "INSERT INTO Beneficiaries (surname, first_name, middle_name,email,phone_No,address) VALUES ('surname.Text', 'first_name.Text','middle_name.Text','email.Text',"'+ phone_No +'",'address.Text')";
