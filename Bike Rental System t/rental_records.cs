...
namespace Bike_Rental_System
{
    public partial class rental_records : Form
    {
        ...
        {
            Con.Open();
            string query = "SELECT rental_record_No, bike_No, beneficiary_No, rental_date, return_date, bike_condition_before, bike_condition_after, staff_lender_No, staff_receiver_No from Rental_records WHERE Rental_records.isValid = 'TRUE'";
            SqlDataAdapter sqldata = new SqlDataAdapter(query, Con);
            System.Data.DataTable dtbl = new System.Data.DataTable();
            sqldata.Fill(dtbl);
            dgvrentalrec.DataSource = dtbl;
        ...
        {
            string query = "SELECT rental_record_No, bike_No, beneficiary_No, rental_date, return_date, bike_condition_before, bike_condition_after, staff_lender_No, staff_receiver_No from Rental_records WHERE Rental_records.isValid = 'FALSE'";
            SqlDataAdapter sqldata = new SqlDataAdapter(query, Con);
            System.Data.DataTable dtbl = new System.Data.DataTable();
            sqldata.Fill(dtbl);
            dgvrentalrec.DataSource = dtbl;
